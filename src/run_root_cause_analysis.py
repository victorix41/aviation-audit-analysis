...
def run_root_cause_analysis() -> None:
    ...
    print(
        f"Unique specified root causes: "
        f"{result.unique_root_causes}"
    )
    ...
    print(
        f"Top root cause: "
        f"{result.top_root_cause}"
    )

    print(
        f"Frequency: "
        f"{result.top_root_cause_frequency}"
    )

    print(
        f"Percentage of all findings: "
        f"{result.top_root_cause_percentage:.2f}%"
    )
