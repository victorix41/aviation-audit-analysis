"""Command-line runner for preventive-action analytics."""
...
def run_preventive_action_analysis() -> None:
    """Run preventive-action analysis using the audit register."""
    ...
    print(
        f"Unspecified preventive actions: "
...
if __name__ == "__main__":
    run_preventive_action_analysis()