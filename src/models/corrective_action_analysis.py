"""Result model for corrective-action analytics."""
...
class CorrectiveActionAnalysis:
    """Structured output from the corrective-action analytics engine."""
    ...
    top_corrective_action: str | None
    ...
    def specified_percentage(self) -> float:
        """Return the percentage of specified corrective actions."""
    ...
    def unspecified_percentage(self) -> float:
        """Return the percentage of unspecified corrective actions."""
