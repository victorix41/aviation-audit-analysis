"""Result model for root-cause analytics."""
...
class RootCauseAnalysis:
    """Structured output from the root-cause analytics engine."""
    ...
    def specified_percentage(self) -> float:
        """Return the percentage of findings with a root cause."""
    ...
    def unspecified_percentage(self) -> float:
        """Return the percentage of findings without a root cause."""
