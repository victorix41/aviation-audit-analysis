...
def run_corrective_action_analysis() -> None:
    ...
    print(f"Unique specified corrective actions: {result.unique_corrective_actions}")

    print("\nLeading corrective action")
    print("-" * 100)

    print(f"Top corrective action: {result.top_corrective_action}")

    print(f"Frequency: {result.top_corrective_action_frequency}")

    print(f"Percentage of all findings: {result.top_corrective_action_percentage:.2f}%")
